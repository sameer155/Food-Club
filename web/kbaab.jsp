<%-- 
    Document   : kbaab
    Created on : Oct 18, 2017, 11:54:46 AM
    Author     : Sameer Alam
--%>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color:green; color:orange">
          ...
          <h4 class="modal-title">Fill your details to place your oder.</h4>
        </div>
