            ...
            <div class="container"> 
                <div class="row">
                    ...
                    <div class="col-sm-9 text-right contact_info">
                        <span class="glyphicon glyphicon-envelope"></span> Food Club,    
                        <span class="glyphicon glyphicon-earphone"></span>  +91-8130606244
                    </div>
                </div>
            </div>
        </div> <!--end of header-->
        ...
        <nav class="navbar navbar-inverse" style="margin-bottom:0px;">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <a class="navbar-brand" href="#" style="color:#00FF7F">Food Club</a>
            ...
            <c:forEach var="a" items="${value}" >
                ...
                <div class="column">
                    <div class="card" style="background-color: white">
                        <img src="${a.getCarimage()}" width="320px" height="310px"/> 
                        <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-4 midfooter">
                    ...
                    <ul>
                        ...
                        <li><a href="contact.jsp">&raquo; Contact Us</a></li>
                    </ul>

                </div>
                <div class="col-sm-4"></div>
                <h3>Contact Details</h3>
                <p>Address : </strong> Sameer Alam,(Delhi)</p>
                <p>Email : </strong> sam.alam155@gmail.com</p>
                <p>Phone : </strong>8130606244</p>
