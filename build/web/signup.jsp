<%-- 
    Document   : signup
    Created on : Oct 24, 2017, 11:41:58 AM
    Author     : Sameer Alam
--%>
			...
			<div class="head">
				<div class="head-nav-grids">
					<div class="navbar-top">
							...
							<li><a href="adminlogin.jsp" data-hover="Admin Login">Admin Login
                                                                     <li><a href="login.jsp"  data-hover="Login">Login</a></li>
                                                                     <li class="active"><a href="signup.jsp" data-hover="SignUp">SignUp</a> </li>
