<%-- 
    Document   : contact
    Created on : Oct 4, 2017, 12:00:10 PM
    Author     : Sameer Alam
--%>
				...
				<div class="head-nav-grids">
					<div class="navbar-top">
							...
							<li><a href="home.jsp" data-hover="Home">Home</a> </li>
								...
								<li class="active"><a href="contact.jsp" data-hover="Contact">Contact</a></li>
				...
				<div class="address-grids">
					<div class="col-md-4 address-text">
						<div class="address-grid">
							<h5>Food Club, 
								<span>South Extension Part-2,New Delhi</span>
							</h5>
							...
							<div class="address-info">
								...
								<div class="e-mail">
									<p>E-mail : <a href="mailto:example@email.com">sam.alam155@gmail.com</a></p>
								</div>
						</div>
					</div>
					<div class="col-md-4 address-text">
						<div class="address-grid">
							<h5>D-42 Chattarpur, 
								<span>Chattarpur Enclave,New Delhi</span>
							</h5>
							<div class="address-info">
								<div class="address-info-left">
									<p>Freephone :</p>
							...
							<div class="e-mail">
								<p>E-mail : <a href="mailto:example@email.com">sameer058@yahoo.com</a></p>
							</div>
						</div>
					</div>
					<div class="col-md-4 address-text">
						<div class="address-grid">
							<h5>B-109 Lado Srai, 
								<span>Gumbaj Park,New Delhi-110074</span>
							</h5>
							<div class="address-info">
								<div class="address-info-left">
									<p>Freephone :</p>
							...
							<div class="e-mail">
								<p>E-mail : <a href="mailto:example@email.com">sameer123@gmail.com</a></p>
							</div>
						</div>
					</div>
					<div class="clearfix"> </div>
